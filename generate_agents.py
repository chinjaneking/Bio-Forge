...
agent_templates = [
    ...
    # 六、Synasalid专项 (20个)
    ("Synasalid发酵优化智能体", "Synasalid发酵工艺优化、参数调整和产量提升", "RHODIOLA_PROJECT", 1),
    ("Synasalid提取纯化智能体", "Synasalid提取工艺优化、纯化方法和回收率提升", "RHODIOLA_PROJECT", 1),
    ("Synasalid质量分析智能体", "Synasalid质量标准建立、分析方法和质量控制", "RHODIOLA_PROJECT", 2),
    ("Synasalid稳定性研究智能体", "Synasalid稳定性考察、影响因素和储存条件", "RHODIOLA_PROJECT", 2),
    ("Synasalid中试放大智能体", "Synasalid中试放大工艺、参数优化和验证", "RHODIOLA_PROJECT", 1),
    ("Synasalid申报资料智能体", "Synasalid申报资料准备、CTD格式和注册策略", "RHODIOLA_PROJECT", 2),
    ("Synasalid专利保护智能体", "Synasalid专利布局、专利申请和专利战略", "RHODIOLA_PROJECT", 3),
    ("Synasalid市场分析智能体", "Synasalid市场调研、竞品分析和市场定位", "RHODIOLA_PROJECT", 3),
    ("Synasalid合作对接智能体", "Synasalid商务合作、技术合作和资源对接", "RHODIOLA_PROJECT", 3),
    ("Synasalid产业化规划智能体", "Synasalid产业化规划、产能布局和商业计划", "RHODIOLA_PROJECT", 2),
    
    ("Synasalid酶工程智能体", "Synasalid关键酶工程、催化效率优化和稳定性提升", "RHODIOLA_PROJECT", 1),
    ("Synasalid途径优化智能体", "Synasalid代谢途径优化、通量平衡和前体供应", "RHODIOLA_PROJECT", 1),
    ("Synasalid菌株改造智能体", "Synasalid生产菌株改造、基因编辑和底盘优化", "RHODIOLA_PROJECT", 2),
    ("Synasalid培养基筛选智能体", "Synasalid培养基筛选、成分优化和成本控制", "RHODIOLA_PROJECT", 2),
    ("Synasalid补料策略智能体", "Synasalid补料策略优化、溶氧控制和pH控制", "RHODIOLA_PROJECT", 2),
    ("Synasalid分离工艺智能体", "Synasalid分离工艺优化、树脂筛选和纯度提升", "RHODIOLA_PROJECT", 2),
    ("Synasalid结晶工艺智能体", "Synasalid结晶工艺优化、晶型控制和收率提升", "RHODIOLA_PROJECT", 3),
    ("Synasalid干燥工艺智能体", "Synasalid干燥工艺优化、水分控制和稳定性", "RHODIOLA_PROJECT", 3),
    ("Synasalid包装材料智能体", "Synasalid包装材料选择、相容性考察和稳定性", "RHODIOLA_PROJECT", 3),
    ("Synasalid质量标准智能体", "Synasalid质量标准制定、方法验证和质量控制", "RHODIOLA_PROJECT", 2),
]
