...
class AgentManager:
    ...
    def initialize_default_agents(self):
        ...
        default_agents = [
            ...
            { "name": "Synasalid发酵优化智能体", "description": "Synasalid发酵工艺优化、参数调整和产量提升", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 1, "capabilities": [] },
            { "name": "Synasalid提取纯化智能体", "description": "Synasalid提取工艺优化、纯化方法和回收率提升", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 1, "capabilities": [] },
            { "name": "Synasalid质量分析智能体", "description": "Synasalid质量标准建立、分析方法和质量控制", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid稳定性研究智能体", "description": "Synasalid稳定性考察、影响因素和储存条件", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid中试放大智能体", "description": "Synasalid中试放大工艺、参数优化和验证", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 1, "capabilities": [] },
            { "name": "Synasalid申报资料智能体", "description": "Synasalid申报资料准备、CTD格式和注册策略", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid专利保护智能体", "description": "Synasalid专利布局、专利申请和专利战略", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 3, "capabilities": [] },
            { "name": "Synasalid市场分析智能体", "description": "Synasalid市场调研、竞品分析和市场定位", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 3, "capabilities": [] },
            { "name": "Synasalid合作对接智能体", "description": "Synasalid商务合作、技术合作和资源对接", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 3, "capabilities": [] },
            { "name": "Synasalid产业化规划智能体", "description": "Synasalid产业化规划、产能布局和商业计划", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid酶工程智能体", "description": "Synasalid关键酶工程、催化效率优化和稳定性提升", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 1, "capabilities": [] },
            { "name": "Synasalid途径优化智能体", "description": "Synasalid代谢途径优化、通量平衡和前体供应", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 1, "capabilities": [] },
            { "name": "Synasalid菌株改造智能体", "description": "Synasalid生产菌株改造、基因编辑和底盘优化", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid培养基筛选智能体", "description": "Synasalid培养基筛选、成分优化和成本控制", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid补料策略智能体", "description": "Synasalid补料策略优化、溶氧控制和pH控制", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid分离工艺智能体", "description": "Synasalid分离工艺优化、树脂筛选和纯度提升", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] },
            { "name": "Synasalid结晶工艺智能体", "description": "Synasalid结晶工艺优化、晶型控制和收率提升", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 3, "capabilities": [] },
            { "name": "Synasalid干燥工艺智能体", "description": "Synasalid干燥工艺优化、水分控制和稳定性", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 3, "capabilities": [] },
            { "name": "Synasalid包装材料智能体", "description": "Synasalid包装材料选择、相容性考察和稳定性", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 3, "capabilities": [] },
            { "name": "Synasalid质量标准智能体", "description": "Synasalid质量标准制定、方法验证和质量控制", "agent_type": AgentType.RHODIOLA_PROJECT, "priority": 2, "capabilities": [] }
        ]
